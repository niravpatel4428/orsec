            ...
            <div className="flex-1">
              <div className="flex flex-wrap gap-5 text-base text-gray-medium leading-relaxed bottomFade">
                <p>
                  ...
                  menaces et en fournissant des informations précieuses sur le
                  trafic réseau. Elle permet d'identifier les comportements
                  suspects, de prévenir les cyberattaques et de prendre des
                  mesures appropriées pour protéger les infrastructures
                  critiques.
                </p>
              </div>
            </div>
