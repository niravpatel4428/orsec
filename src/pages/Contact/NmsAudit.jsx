...
import imgMobile from "../../assets/contact-form-mobile.png";
      ...
      <div className="flex flex-col justify-center max-w-700 w-full mx-auto px-4 lg:p-8">
        <div className="mb-9">
          <div className="mb-2 md:mb-8">
            <h2 className="text-light text-[35px] md:text-40 leading-130">
              Je souhaite tester NMS Audit
            </h2>
          </div>
          <div className="text-base text-gray-medium gap-5">
            <p>
