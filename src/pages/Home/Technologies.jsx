      ...
      <div className="custom-container">
        <div className="grid grid-cols-12 max-sm:gap-6 mb-8 md:mb-12">
          <div className="col-span-12 md:col-span-6">
            <p className="text-gray-medium text-base ">[Fonction]</p>
          </div>
          <div className="col-span-12 md:col-span-6">
            <div className="lg:pr-10 xl:pr-24 xxl:pr-44">
              <h3 className="text-light text-2xl md:text-26 lg:text-28 xl:text-32 leading-130">
                Comment fonctionnent les DPI, à l&apos;origine des
                solutions{" "}
