...
const Notices = () => {
    const infoList = [
        ...
        {
            title: "Fermeture ou suspension du « Site Internet » et / ou « Portail Clients »",
            detail: [
    ...
    return (
        ...
        <section className='pt-44 md:pt-52 xl:pt-60  -mt-[68px] lg:-mt-20'>
            <div className="custom-container">
                <h2 className="text-light text-center text-5xl md:text-6xl lg:text-7xl leading-130 mb-32 md:mb-16 lg:mb-28">
                    Mentions Légales
                </h2>
