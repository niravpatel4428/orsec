...
const FeatureCard = ({ icon, title, description }) => {
  return (
    ...
    <div className="relative h-full border border-[#2D2C3C] rounded-lg flex flex-col justify-between items-center gap-9 md:gap-7 p-8 sm:p-5 xl:p-10 fade-card">
      ...
      <div className="custom-container">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-15 mb-7 md:mb-14 xxl:mb-20">
          <div className="md:col-span-8">
            <div>
              <h2 className="text-light text-lg sm:text-xl md:text-26 lg:text-28 xl:text-35 xxl:text-40 !leading-120 bottom-fade">
          ...
          <div className="col-span-4 hidden md:block">
            <div className="h-full flex justify-end items-end bottom-fade">
