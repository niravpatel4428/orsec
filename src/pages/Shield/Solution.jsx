      ...
      <div className="custom-container">
        <div className="grid grid-cols-1 md:grid-cols-12 mb-8 md:mb-12">
          <div className="md:col-span-8 lg:col-span-9">
            <div className="flex flex-col gap-6 md:gap-8">
              <h2 className="text-light text-lg sm:text-xl md:text-2xl lg:text-3xl xxl:text-40 !leading-130 animated-title">
                <span>
                  {" "}
                  Une solution <p className="inline-block text-gray-light">militaire&nbsp;</p>
                  permanente{" "}
                </span>{" "}
        ...
        <div className="grid max-[389px]:grid-cols-1 grid-cols-2 lg:grid-cols-4 gap-4">
          {features.map((feature, index) => (
            <div
              key={index}
              className="h-full border border-[#2D2C3C] bg-techGradient rounded-lg flex flex-col justify-end gap-9 md:gap-7 py-6 px-4 sm:p-5 xl:p-8 xxl:p-10 StepByStepBlock"
            >
